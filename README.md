...
EFIDOSBOX6 EFI File with dosbos.efi named for boot x86_64 8086 emulator and boot .EXE file of DOS 16-bit type MZ Header embebed.
EFIDOSBOX6-EXE-VRAM EFI File and ISO for boot emulator 8086 in x86_64 and boot .EXE file of DOS 16-bit type MZ Header embebed and start Video Representation en in mode 8086 - 13h. File dosbox-LENOVO-VRAM.efi.
